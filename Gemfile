...
# (ver docker-compose.livekit.yml em dev; em prod, self-host ou LiveKit Cloud).
...
group :development do
  ...
  gem 'bullet'
  gem 'letter_opener'
  # UI web em /letter_opener para inspecionar emails interceptados (handy
  # quando o disparo veio de outro dispositivo — celular via tunnel, etc.).
