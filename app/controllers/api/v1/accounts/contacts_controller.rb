class Api::V1::Accounts::ContactsController < Api::V1::Accounts::BaseController
  ...
  RESULTS_PER_PAGE = 15
  ALLOWED_PAGE_SIZES = [15, 50, 100].freeze
  ...
  def set_current_page
    ...
    requested_size = params[:page_size].to_i
    @page_size = ALLOWED_PAGE_SIZES.include?(requested_size) ? requested_size : RESULTS_PER_PAGE
  end
  ...
  def fetch_contacts(contacts)
    ...
    filtrate(contacts)
      ...
      .page(@current_page)
      .per(@page_size || RESULTS_PER_PAGE)
  end
  ...
  def fetch_contacts_with_has_more(contacts)
    ...
    page_size = @page_size || RESULTS_PER_PAGE
