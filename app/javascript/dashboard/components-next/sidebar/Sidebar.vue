  ...
  const items = [
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          to: accountScopedRoute('agenda_settings_index'),
          activeOn: ['agenda_settings_index'],
        },
        {
          name: 'Custom Attributes',
          label: t('SIDEBAR.CUSTOM_ATTRIBUTES', 'Custom Attributes'),
          to: accountScopedRoute('agenda_custom_attributes_index'),
          activeOn: ['agenda_custom_attributes_index'],
        },
      ],
    },
    // Sprint L — Aba "Teleconsulta": lista + detalhe (player + transcrição
    // + evolução proposta pela IA). Entre Agenda e Pacientes (PRD §6).
    {
      name: 'Teleconsulta',
      icon: 'i-lucide-video',
      label: t('SIDEBAR.TELECONSULTA', 'Teleconsulta'),
      to: accountScopedRoute('teleconsultas_index'),
      activeOn: ['teleconsultas_index', 'teleconsulta_detail'],
    },
    {
      name: 'Patients',
      icon: 'i-lucide-users',
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          label: 'Auditoria',
          to: accountScopedRoute('financial_v2_audit'),
          activeOn: ['financial_v2_audit'],
        },
        {
          name: 'Financial Backups',
          label: 'Backups',
          to: accountScopedRoute('financial_v2_backups'),
          activeOn: ['financial_v2_backups'],
        },
        {
          name: 'Financial Accountant Export',
          label: 'Contador',
          to: accountScopedRoute('financial_v2_accountant_export'),
          activeOn: ['financial_v2_accountant_export'],
        },
        {
          name: 'Financial LGPD',
          label: 'LGPD',
          to: accountScopedRoute('financial_v2_lgpd'),
          activeOn: ['financial_v2_lgpd'],
        },
        {
        ...
        {
          name: 'Financial Reclassify',
          label: 'Reclassificar',
          to: accountScopedRoute('financial_v2_reclassify'),
          activeOn: ['financial_v2_reclassify'],
        },
        {
    ...
    },
    {
      ...
      children: [
        ...
        {
          name: 'Reports Agenda',
          label: t('SIDEBAR.REPORTS_AGENDA'),
          to: accountScopedRoute('agenda_reports'),
        },
      ],
    },
...
<template>
  <aside
    ...
    class="bg-n-background flex flex-col text-sm pb-px fixed ltr:left-2 rtl:right-2 inset-y-2 z-40 w-[200px] lg:w-auto lg:relative lg:inset-y-0 lg:flex-shrink-0 lg:ltr:translate-x-0 lg:rtl:translate-x-0 lg:my-2 lg:ltr:mr-2 lg:rtl:ml-2 rounded-xl shadow-md"
    :class="[
      {
        'shadow-xl lg:shadow-md': isMobileSidebarOpen,
        'ltr:-translate-x-[calc(100%+0.5rem)]': !isMobileSidebarOpen && !isRTL,
        'rtl:translate-x-[calc(100%+0.5rem)]': !isMobileSidebarOpen && isRTL,
  ...
  >
    ...
    >
      ...
      >
        <template v-if="isEffectivelyCollapsed">
          ...
          />
          <button
            class="hidden lg:flex flex-shrink-0 items-center justify-center size-8 rounded-lg outline-none focus-visible:ring-2 focus-visible:ring-n-brand text-n-slate-11 hover:text-n-slate-12 hover:bg-n-alpha-2 transition-colors mt-2 mx-auto"
            title="Expandir menu"
            @click="onResizeHandleDoubleClick"
          >
            <i class="i-lucide-panel-left-open text-lg xl:text-xl" />
          </button>
        </template>
        <template v-else>
    ...
    >
      ...
      />
      <div
        class="px-1 py-1.5 flex-shrink-0 flex w-full z-50 gap-2 items-center"
