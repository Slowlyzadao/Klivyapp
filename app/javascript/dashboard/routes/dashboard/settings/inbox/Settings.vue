...
import WhatsappQRStatus from './channels/WhatsappQRStatus.vue';
...
export default {
  ...
  computed: {
    ...
    isWhatsAppQRChannel() {
      return this.inbox.provider === 'whatsapp_qr';
    },
    ...
    tabs() {
      ...
      if (this.isWhatsAppQRChannel) {
        visibleToAllChannelTabs = [
          ...visibleToAllChannelTabs,
          {
            key: 'whatsapp-qr-status',
  ...
  >
    ...
    <section class="w-full overflow-auto py-8">
      <div class="max-w-7xl mx-auto w-full">
        ...
        <div
          v-if="selectedTabKey === 'whatsapp-qr-status'"
          class="mx-6 max-w-2xl"
        >
          <WhatsappQRStatus :inbox="inbox" :account-id="accountId" />
        </div>
      </div>
    </section>
  </div>
