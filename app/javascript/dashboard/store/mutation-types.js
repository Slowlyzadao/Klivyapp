export default {
  ...
  // Agenda Events
  SET_AGENDA_EVENT_UI_FLAG: 'SET_AGENDA_EVENT_UI_FLAG',
  SET_AGENDA_EVENTS: 'SET_AGENDA_EVENTS',
  UPSERT_AGENDA_EVENTS: 'UPSERT_AGENDA_EVENTS',
  ADD_AGENDA_EVENT: 'ADD_AGENDA_EVENT',
  EDIT_AGENDA_EVENT: 'EDIT_AGENDA_EVENT',
  DELETE_AGENDA_EVENT: 'DELETE_AGENDA_EVENT',

  // Agenda Notification Rules
  SET_AGENDA_NOTIF_RULE_UI_FLAG: 'SET_AGENDA_NOTIF_RULE_UI_FLAG',
  SET_AGENDA_NOTIF_RULES: 'SET_AGENDA_NOTIF_RULES',
  ADD_AGENDA_NOTIF_RULE: 'ADD_AGENDA_NOTIF_RULE',
  EDIT_AGENDA_NOTIF_RULE: 'EDIT_AGENDA_NOTIF_RULE',
  DELETE_AGENDA_NOTIF_RULE: 'DELETE_AGENDA_NOTIF_RULE',

  // Agenda Services
  SET_AGENDA_SERVICE_UI_FLAG: 'SET_AGENDA_SERVICE_UI_FLAG',
  SET_AGENDA_SERVICES: 'SET_AGENDA_SERVICES',
  ADD_AGENDA_SERVICE: 'ADD_AGENDA_SERVICE',
  EDIT_AGENDA_SERVICE: 'EDIT_AGENDA_SERVICE',
  DELETE_AGENDA_SERVICE: 'DELETE_AGENDA_SERVICE',

  // Agenda Categories
  SET_AGENDA_CATEGORY_UI_FLAG: 'SET_AGENDA_CATEGORY_UI_FLAG',
  SET_AGENDA_CATEGORIES: 'SET_AGENDA_CATEGORIES',
  ADD_AGENDA_CATEGORY: 'ADD_AGENDA_CATEGORY',
  EDIT_AGENDA_CATEGORY: 'EDIT_AGENDA_CATEGORY',
  DELETE_AGENDA_CATEGORY: 'DELETE_AGENDA_CATEGORY',
