  ...
  class << self
    ...
    def assistant_response_generator(assistant_name, product_name, config = {})
      ...
      <<~SYSTEM_PROMPT_MESSAGE
        ...
        - Always detect the language from input and reply in the same language. If the input has no detectable language (e.g. it contains only attachments, images, audio, or is empty), default to Brazilian Portuguese (pt-BR). Do not use any other language.
