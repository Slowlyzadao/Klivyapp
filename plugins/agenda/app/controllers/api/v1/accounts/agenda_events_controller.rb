class Api::V1::Accounts::AgendaEventsController < Api::V1::Accounts::BaseController
  # `telemedicine_token` é member → precisa do @agenda_event carregado.
  ...
  def agenda_event
    ...
    #
    # Sprint K — aceita também slug `pppp-eeee-aaaa` (rota
    # /agenda/telemed/0017-0284-0076). Sem o check explícito,
    # `.find('17-284-76')` no Rails faz `to_i` → '17' e abriria evento errado.
    @agenda_event ||= Current.account.agenda_events.find(resolve_event_id(params[:id]))
  end
