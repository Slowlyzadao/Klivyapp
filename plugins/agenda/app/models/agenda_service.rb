...
#
# Preço foi MOVIDO para `Financial::ServicePricing` em 2026-05-22 (1-to-1 com
# AgendaService via account_id + agenda_service_id). Ver canon
# `docs/01-product/modules/financeiro-funcionamento.md` e
# `docs/audits/financial-2026-05-implementation.md` §0.
