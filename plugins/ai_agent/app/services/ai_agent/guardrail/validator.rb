  ...
  module Guardrail
    ...
    class Validator
      ...
      def call
        ...
        return Result.new(safe: true, sanitized_message: @message, violations: []) if violations.empty?

        Result.new(safe: false, sanitized_message: SAFE_FALLBACK, violations: violations)
      end
