    ...
    class << self
      def all
        @all ||= [
          ...
          # Campos de preenchimento (input.*) — resolvidos do mapa `inputs`
          # passado na geração, não de cadastro. Ver InputDefinitions/Resolver.
          Variables::InputDefinitions::LIST
        ].flatten.freeze
      end
