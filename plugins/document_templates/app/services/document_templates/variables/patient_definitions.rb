...
module DocumentTemplates
  module Variables
    ...
    #   - Patient.guardian (JSONB) com name/cpf/phone/relationship quando
    #     has_guardian=true (não há RG do responsável no cadastro)
    ...
    module PatientDefinitions
      LIST = [
        ...
        # O cadastro do responsável coleta name/cpf/phone/relationship (sem RG).
        ...
        { key: 'patient.guardian_relationship', label: 'Parentesco do responsável', example: 'Mãe' },
        { key: 'patient.guardian_phone',        label: 'Telefone do responsável',   example: '(11) 98765-4321', formatter: :phone },
