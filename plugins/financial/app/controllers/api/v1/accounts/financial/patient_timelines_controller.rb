    ...
    module Accounts
      module Financial
        ...
        class PatientTimelinesController < BaseController
          ...
          # RBAC: leitura da timeline financeira do paciente exige
          # `patients.view_financial` (mesma key da aba no frontend). Fecha o
          # fail-open anterior. Bypass de admin/super_admin em `beclinic_can?`.
          ...
          def serialize_installment(inst, today)
            ...
            breakdown = receipt_breakdown_for(inst)

            {
              ...
              # Breakdown agregado dos recibos (UX 2026-05-24) — usado pelo ícone
              # info + Tooltip pra exibir juros/multa/desconto/crédito sem
              # precisar abrir o recibo. Mesma estrutura do InstallmentsController.
          ...
          # Mesma agregação do InstallmentsController#receipt_breakdown_for —
          # duplicado intencionalmente pra evitar cross-controller dependency.
          # Quando virar uso recorrente, mover pra um query object/concern.
