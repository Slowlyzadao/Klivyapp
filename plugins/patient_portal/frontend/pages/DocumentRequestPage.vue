  ...
  <AppShell>
    ...
    <div class="pp-doc-req">
      <p class="pp-doc-req__intro">
        Pediu um atestado, receita ou recibo? Solicite e a clínica retorna com o documento.
      </p>
      ...
      <BaseCard title="O que você precisa?">
        ...
        <label class="pp-doc-req__field" v-if="hasPriorDocs">
      ...
      <p class="pp-doc-req__hint">
        A clínica analisa em até 2 dias úteis. Você recebe o documento aqui mesmo
        ou aviso de recusa com motivo.
      </p>
    </div>
  </AppShell>
</template>
...
const canSubmit = computed(() => form.value.document_type && form.value.reason.trim().length >= 5);
...
<style scoped>
.pp-doc-req { padding: 16px; display: flex; flex-direction: column; gap: 16px; }
.pp-doc-req__intro { margin: 0; font-size: 14px; color: var(--pp-color-text-muted); }

.pp-doc-req__field { display: flex; flex-direction: column; gap: 6px; margin-bottom: 12px; }
.pp-doc-req__field:last-child { margin-bottom: 0; }
.pp-doc-req__label { font-size: 12px; font-weight: 600; color: var(--pp-color-text-muted); }
.pp-doc-req__select,
...
.pp-doc-req__error { color: #b91c1c; font-size: 13px; margin: 0; }
.pp-doc-req__hint  { text-align: center; font-size: 12px; color: var(--pp-color-text-muted); margin: 0; }
</style>
