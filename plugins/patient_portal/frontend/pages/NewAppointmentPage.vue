...
function addSlot() {
  if (slots.value.length < 3) slots.value.push('');
}
  ...
  <AppShell>
    ...
    <div class="pp-new-appt">
      ...
      <p class="pp-new-appt__hint">
        Sua solicitação fica na fila da recepção. Você recebe uma notificação
        quando a clínica confirmar o horário.
      </p>
    </div>
  </AppShell>
</template>
...
.pp-new-appt__slot:last-of-type {
  margin-bottom: 0;
}
.pp-new-appt__input {
  flex: 1;
