...
// PAYMENT_METHOD_OPTIONS removido 2026-05-25 — não tinha mais callers.
// Componentes agora carregam a lista REAL via `FinancialV2.paymentMethods.index`
// e usam o componente único `@plugins/beclinic_core/.../PaymentMethodBadge.vue`
// (single source of truth canon). Mantido apenas BADGE_LABELS abaixo porque
// `financialPrintTemplates.js` (gera HTML pra PDF) não pode importar Vue.
