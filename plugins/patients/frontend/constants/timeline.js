...
// `financial` removido 2026-05-24: eventos órfãos do v1, visão financeira
// vive na aba Financeiro do prontuário. Controller também filtra
// `payment`/`refund` da query (HIDDEN_EVENT_TYPES).
