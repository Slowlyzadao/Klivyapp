      ...
      <div class="pp-telemed-preflight__shell">
        ...
        <section class="pp-telemed-preflight__panel">
          ...
          <div class="pp-telemed-preflight__security">
            ...
            <Checkbox v-model="recordingConsent">
              <span class="pp-telemed-preflight__consent-text">
                Li e aceito os
                <!-- eslint-disable-next-line vue/max-attributes-per-line -->
                <a href="#" @click.stop.prevent="showConsentTerms = true"
...
.pp-telemed-room__status-pill {
  ...
  gap: 8px;
  padding: 5px 12px;
  /* Verde SÓLIDO + texto branco — o header tem fundo variável (claro na
     sala de espera, escuro com vídeo); o tint claro + texto verde-claro
     antigo (#86efac) sumia no fundo claro. Sólido garante contraste em
     qualquer fundo. */
  background: #16a34a;
  color: #ffffff;
...
.pp-telemed-preflight__preview {
  ...
  width: 100%;
  aspect-ratio: 16 / 9;
  /* Cinza-escuro neutro (sem tom azul) enquanto a câmera inicializa —
     tile de vídeo é sempre escuro, mas neutro, não azul-marinho. */
  background: #1c1b1b;
  border-radius: 16px;
  overflow: hidden;
...
.pp-telemed-preflight__camoff {
  ...
  justify-content: center;
  gap: 14px;
  /* Mesmo cinza-escuro neutro do tile (sem tom azul-marinho) + texto
     cinza-claro neutro. Tile de vídeo é sempre escuro, não segue tema. */
  background: #1c1b1b;
  color: #d4d4d8;
}
